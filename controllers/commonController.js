...
exports.updateRegistration = async (req, res) => {
    ...
    const {
        ...
        bank_id,
        notes
    } = req.body.updateData || req.body; // Handle both nested and flat structure
    ...
    // Get the complete updated registration with all relations
    ...
    if (fullRegistrationError) {
        console.log('Error fetching updated registration:', fullRegistrationError);
    }
